...
import os
from .utils import get_chatbot_response, get_embeddings, double_check_json_output
...
class RecommendationAgent():
    ...
    def get_popular_recommendation(self, product_categories=None, top_k=5):
        ...
        recommendation_df = recommendation_df.sort_values('number of transactions', ascending=False)
    ...
    def get_response(self, messages):
        ...
        if recommendations == []:
            return {"role":"assistant", 'content': 'Sorry I cant with that recommendation. Can I help you with something else'}
